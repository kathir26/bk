<?php 
class Muvacon_Testimonials_Block_Adminhtml_Testimonials_Helper_Image extends Varien_Data_Form_Element_Image{
	...
	public function getElementHtml() {
		$html = '';
		if ($this->getValue()) {           
			$media = Mage::getBaseUrl('media').'Muvacon/Testimonials/';
